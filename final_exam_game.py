...
def play_starter_pattern():
    for _ in range(3):
        set_energy(led_pins[2], True, False)
        time.sleep(0.1)
        set_energy(led_pins[2], False, False)

        set_energy(led_pins[1], True, False)
        set_energy(led_pins[3], True, False)
        time.sleep(0.1)
        set_energy(led_pins[1], False, False)
        set_energy(led_pins[3], False, False)

        set_energy(led_pins[0], True, False)
        set_energy(led_pins[4], True, False)
        time.sleep(0.1)
        set_energy(led_pins[0], False, False)
        set_energy(led_pins[4], False, False)
    time.sleep(0.5)
